...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    <aside
      className={cn(
        "group/sidebar relative flex h-full flex-col overflow-y-auto",
        expanded ? "w-64" : "w-16",
...
const SidebarGroupLabel = ({
  ...
  return (
    <div
      className={cn(
        "flex items-center px-2 py-1.5 text-sm font-medium text-muted-foreground",
    ...
    >
      {expanded ? (
        ...
        <div className="flex w-full items-center justify-center">{React.isValidElement(children) && children}</div>
      )}
    </div>
  )
}
