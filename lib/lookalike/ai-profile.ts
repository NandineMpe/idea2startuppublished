  ...
  if (!isLlmConfigured()) {
    ...
    return {
      ...
      convertedLead: {
        ...
        channel,
        responseTime,
        multiplierNote: "Set DASHSCOPE_API_KEY or LLM_API_KEY to generate multiplier and lookalike criteria.",
      },
      ...
      proactiveMessage: "Connect DASHSCOPE_API_KEY or LLM_API_KEY to scan your saved Juno leads for lookalikes.",
