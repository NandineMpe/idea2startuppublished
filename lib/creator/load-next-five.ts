...
const DRAFT_COLUMNS =
  "id,kind,state,autonomy,title,body,premise,script_sections,visual_plan,rationale,provenance,created_at,decided_at,format_id,pillar_id,hook,estimated_duration_seconds"
