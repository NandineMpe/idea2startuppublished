        ...
        <div className="max-w-7xl mx-auto p-6 space-y-8 min-h-full">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-border pb-8">
                ...
                <div className="hidden md:block text-right space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground/40">Based on data density & connectivity</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Link href="/dashboard/knowledge/founders-journey" className="group">
                    <Card className="h-full bg-white/[0.02] border-border group-hover:border-primary/50 group-hover:bg-primary/5 transition-all duration-300">
                        <CardHeader>
                    ...
                    <CardContent>
                        <div className="flex gap-2">
                            <Input
                                ...
                                className="bg-background/50 border-purple-500/30 text-foreground placeholder:text-foreground/20"
                                value={inputContent}
            ...
            <div className="space-y-6 pt-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="relative w-96">
                        ...
                        <Input
                            ...
                            className="pl-9 bg-background/20 border-border text-foreground rounded-full focus:border-primary/50"
                            value={searchQuery}
                ...
                <Card className="bg-background/20 border-border backdrop-blur-xl">
                    <CardContent className="p-0">
                        {isSearching ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-accent border border-border rounded-lg overflow-hidden">
                                {memories.map((memory, i) => (
                                    <div key={i} className="bg-background/90 p-6 hover:bg-background/80 transition-colors group cursor-pointer space-y-4">
                                        <div className="flex justify-between items-start">
                                            <Badge variant="outline" className="text-xs border-primary/20 text-primary bg-primary/5">
                                                Memory Node
                                            </Badge>
                                            <span className="text-[10px] text-foreground/20 font-mono">ID: {Math.random().toString(36).substr(2, 6)}</span>
                                        </div>
                                        ...
                                        <div className="pt-2 border-t border-border flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] text-foreground/40">Active Context</span>
                                        </div>
                                    </div>
                                ))}
                                {memories.length === 0 && (
                                    <div className="col-span-full py-20 text-center text-muted-foreground/40">
